...
class AssignmentTwo(Csse1001TestCase):
    ...
    def test_Loads_tkinter(self):
        with self.subTest("Doesn't load tkinter"):
            global tk_loaded
            if tk_loaded:
                self.fail()
...
def methodCmp(a, b):
    fns = ['test_Loads_tkinter', 'test_No_animals', 'test_One_animal', 'test_Two_animals', 'test_Four_animals', 'test_Inheritance', 'test_Docstrings']
