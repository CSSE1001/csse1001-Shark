...
var DocCommentHighlightRules = function() {
    this.$rules = {
        "start" : [ {
            token : "marking.doc.tag",
            regex : "@[\\w\\d_]+" // TODO: fix email addresses
        }, 
        DocCommentHighlightRules.getTagRule(),
        {
            defaultToken : "marking.doc",
...
DocCommentHighlightRules.getTagRule = function(start) {
    return {
        token : "marking.doc.tag.storage.type",
...
DocCommentHighlightRules.getEndRule = function (start) {
    return {
        token : "marking.doc", // closing comment
        regex : "\\*\\/",
        next  : start
    };
};
...
var PythonHighlightRules = function() {
    ...
    this.$rules = {
        ...
        {
            token : "marking", // multi line comment
            regex : /\/\*/,
            next : "marking"
        },
		{
        ...
        "marking" : [
            DocCommentHighlightRules.getTagRule(),
            {token : "marking", regex : "\\*\\/", next : "start"},
            {defaultToken : "marking", caseInsensitive: true}
        ],
		"line_marking" : [
            DocCommentHighlightRules.getTagRule(),
            {token : "marking", regex : "$|^", next : "start"},
